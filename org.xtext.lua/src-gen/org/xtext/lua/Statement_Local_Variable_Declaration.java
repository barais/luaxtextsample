 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lua.Statement_Local_Variable_Declaration#getVariableNames <em>Variable Names</em>}</li>
 *   <li>{@link org.xtext.lua.Statement_Local_Variable_Declaration#getInitialValue <em>Initial Value</em>}</li>
 * </ul>
 *
 * @see org.xtext.lua.LuaPackage#getStatement_Local_Variable_Declaration()
 * @model
 * @generated
 */
public interface Statement_Local_Variable_Declaration extends Statement
{
   ...
   * @see org.xtext.lua.LuaPackage#getStatement_Local_Variable_Declaration_VariableNames()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.xtext.lua.LuaPackage#getStatement_Local_Variable_Declaration_InitialValue()
