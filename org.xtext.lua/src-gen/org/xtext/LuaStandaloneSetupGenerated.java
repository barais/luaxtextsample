...
public class LuaStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.xtext.LuaRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.xtext.org/Lua")) {
		EPackage.Registry.INSTANCE.put("http://www.xtext.org/Lua", org.xtext.lua.LuaPackage.eINSTANCE);
	}
